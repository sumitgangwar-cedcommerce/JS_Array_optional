...
var comp_arr = [adjusted , notAdjusted];


var text="<table>";
text+="<tr>"+
            "<th rowspan='2'>Quarter</th>"+
            "<th colspan='2'>Retail sales (million of dollars)</th>"+
            "<th rowspan='2'>Ecommerce as a <br>percent of total</th>"+
            "<th colspan='2'>Percent change <br>from prior quarter</th>"+
            "<th colspan='2'>Percent change from <br> same quarter a year ago</th>"
        "</tr>";
text+="<tr>"+
            "<th>Total</th>"+
            "<th>Ecommerce</th>"+
...
text+="<tr>"+
            "<td><strong>Not Adjusted</strong></td>"+
            "<td></td>"+
            "<td></td>"+
            "<td></td>"+
            "<td></td>"+
